...
# list of layers in yolov3 fully connectional network
YOLOV3_LAYER_LIST = [
    'yolo_darknet',
    'yolo_conv_0',
    'yolo_output_0',
...
# load weights from original Yolo trained model in Darknet
...
# drawing bounding box, class name and probability
...
# function of non maximum suppression
...
# function transform targets outputs 
